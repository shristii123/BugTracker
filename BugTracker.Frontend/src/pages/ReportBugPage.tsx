  ...
  return (
    <div className="report-page">
      <div className="report-card">
        ...
        <p className="report-sub">Provide as much detail as possible to help developers reproduce the issue.</p>
        ...
        <form onSubmit={handleSubmit} className="report-form">
          ...
          <div className="form-group">
            ...
            <textarea
              required placeholder="Describe the bug in detail..."
          ...
          <div className="form-actions">
            <button type="button" className="cancel-btn" onClick={() => navigate('/bugs')}>Cancel</button>
